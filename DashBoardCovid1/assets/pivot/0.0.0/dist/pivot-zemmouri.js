(function() {
  ...
  callWithJQuery(function($) {
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      result.appendChild(document.createElement("thead"));
      result.appendChild(document.createElement("tbody"));
      result.appendChild(document.createElement("tfoot"));
        //zemmouri 
      result.id = "pvtTable";
      //result.className = "pvtTable1";
      ...
      for (j in colAttrs)
      {
        ...
        th_Col_Head = document.createElement("th");
          //zemmouri
        //th_Col_Head.className = "pvtAxisLabel1";
        th_Col_Head.innerHTML = c;
        th_Col_Head.setAttribute("colspan", colKeys.length+1);
        for (i in colKeys)
        {
      ...
      if (rowAttrs.length !== 0)
      {
        ...
        if (colAttrs.length === 0) {
            th = document.createElement("th");
            //zemmouri
          //th.className = "pvtTotalLabel2";
          th.innerHTML = opts.localeStrings.totals;
        }
        tr.appendChild(th);
        tr.appendChild(th_Col_Head);
        result.tHead.insertBefore(tr, result.tHead.firstChild);
      }
      for (i in rowKeys) {
        ...
        for (j in colKeys) {
          ...
          td = document.createElement("td");
            //zemmouri
          // td.className = "pvtVal1 row" + i + " col" + j;
        ...
        td = document.createElement("td");
          //zemmouri
      //  td.className = "pvtTotal1 rowTotal";
        td.innerHTML = totalAggregator.format(val);
        td.setAttribute("data-value", val);
        td.setAttribute("data-for", "row" + i);
        tr.appendChild(td);
        result.tBodies[0].appendChild(tr);
      }
      tr = document.createElement("tr");
      th = document.createElement("td");
        //zemmouri
      // th.className = "pvtTotalLabel3";
      th.innerHTML = opts.localeStrings.totals;
      ...
      td.setAttribute("data-value", val);
      tr.appendChild(td);
      result.tFoot.appendChild(tr);

      //result.setAttribute("data-numrows", rowKeys.length);
      //result.setAttribute("data-numcols", colKeys.length);
      result.setAttribute("data-toggle", "table");
      return result;
    };
