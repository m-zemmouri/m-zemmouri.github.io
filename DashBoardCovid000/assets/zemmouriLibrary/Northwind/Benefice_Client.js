...
function Benefice_Client_Ready(myData) {
    ...
    function changeMois(MoisParameter) {
        ...
        // get Chart
        get_Chart_Pie_Benefice_Client(DataMois);
    }
    ...
    // Benefice / Année
    function get_Chart_Pie_Benefice_Client(data) {
        //prepare data
        var parameterClient = { groupBy: "Customer", name: "" + translate("Profit") + "", field: "Profit", aggregation: "sum" };
        var parameterFamille = { groupBy: "Customer Country", name: translate("Profit"), field: "Profit", aggregation: "sum", drilldown: parameterClient };
        ...
        var MyOptions = {
            chart:
            {
                renderTo: "Chart_Pie_Benefice_Client",
                type: 'pie'
            },
            credits:
            {
            ...
            title:
            {
                text: "" + translate("Profit") + " " + Annee + "-" + Mois + " / "+translate("Customer")+""
            },
            tooltip:
            {
                enabled: true,
