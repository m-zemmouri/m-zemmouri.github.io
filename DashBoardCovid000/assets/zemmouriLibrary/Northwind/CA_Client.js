...
function CA_Client_Ready(myData) {
    ...
    function changeMois(MoisParameter) {
        ...
        // get Chart
        get_Chart_Pie_CA_Client(DataMois);
    }
    ...
    // CA / Année
    function get_Chart_Pie_CA_Client(data) {
        //prepare data
        var parameterClient = { groupBy: "Customer", name: "" + translate("Turnover") + "", field: "Extended Price", aggregation: "sum" };
        var parameterFamille = { groupBy: "Customer Country", name: translate("Turnover"), field: "Extended Price", aggregation: "sum", drilldown: parameterClient };
        ...
        var MyOptions = {
            ...
            title:
            {
                text: "" + translate("Turnover") + " " + Annee + "-" + Mois + " / " + translate("Customer") + ""
            },
            tooltip:
            {
                enabled: true,
