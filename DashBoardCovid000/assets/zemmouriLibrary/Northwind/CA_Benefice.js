...
function CA_Benefice_Ready(myData) {
    ...
    function changeAnnee(AnneeParameter) {
        ...
        // get Chart
        get_Chart_Gauge_CA_Performance(DataAnnee);
        get_Chart_Column_CA_Mensuel(DataAnnee);
        get_Chart_Line_CA_Benefice_Mensuel(DataAnnee);
    }
    ...
    // CA Perfection Gauge
    function get_Chart_Gauge_CA_Performance(data) {
        //prepare data
        ...
        var MyOptions = {
            chart:
            {
                renderTo: "Chart_Gauge_CA_Performance",
                type: 'solidgauge'
            },
            credits:
            {
    ...
    function get_Chart_Line_CA_Benefice_Mensuel(data) {
        //prepare data 
        var parameter = { name: translate("Turnover"), field: "Extended Price", aggregation: "sum", categoredBy: "Month", categories: categoriesDictionary["Months"] };
        var series = group(data, parameter);
        ...
        series.data.push(group(data, parameterBenefice).data[0]);

        //Chart options
        var MyOptions = {
            chart:
            {
                renderTo: "Chart_Line_CA_Benefice_Mensuel",
                type: 'line',
            },
            credits:
            {
