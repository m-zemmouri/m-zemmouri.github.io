...
function Benefice_Commercial_Ready(myData) {
    ...
    function changeMois(MoisParameter) {
        ...
        // get Chart
        get_Chart_Pie_Benefice_Commercial(DataMois);
    }
    ...
    function get_Chart_Pie_Benefice_Annuel(data) {
        //prepare data
        var parameter = { groupBy: "Year", name: translate("Profit"), field: "Profit", aggregation: "sum" };
    ...
    // Benefice / Année
    function get_Chart_Pie_Benefice_Commercial(data) {
        //prepare data
        var parameter = { groupBy: "Employe", name: translate("Profit"), field: "Profit", aggregation: "sum" };
        var series = group(data, parameter);
        ...
        var MyOptions = {
            chart:
            {
                renderTo: "Chart_Pie_Benefice_Commercial",
                type: 'pie'
            },
            credits:
            {
            ...
            title:
            {
                text: "" + translate("Profit") + " " + Annee + "-" + Mois + " / "+translate("Commercial")+""
            },
            tooltip:
            {
                enabled: true,
                formatter: function () {
                    return "" + translate("Commercial") + " : <b>" + this.point.name + "</b><br/>" + translate("Profit") + " : <b>" + Highcharts.numberFormat(this.point.y, 2) + "</b><br/>" + translate("Percentage") + " : <b>" + Highcharts.numberFormat(this.percentage, 2) + "%</b>";
                }
            },
            plotOptions:
            {
