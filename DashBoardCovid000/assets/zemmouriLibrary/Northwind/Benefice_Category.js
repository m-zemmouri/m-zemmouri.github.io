...
function Benefice_Category_Ready(myData) {
    ...
    function changeMois(MoisParameter) {
        ...
        // get Chart
        get_Chart_Pie_Benefice_Category(DataMois);
    }
    ...
    // Benefice / Année
    function get_Chart_Pie_Benefice_Category(data) {
        //prepare data
        var parameter = { groupBy: "Category", name: translate("Profit"), field: "Profit", aggregation: "sum" };
        var series = group(data, parameter);
        ...
        var MyOptions = {
            chart:
            {
                renderTo: "Chart_Pie_Benefice_Category",
                type: 'pie'
            },
            credits:
            {
            ...
            title:
            {
                text: "" + translate("Profit") + " " + Annee + "-" + Mois + " / " + translate("Category") + ""
            },
            tooltip:
            {
                enabled: true,
                formatter: function () {
                    return "" + translate("Category") + " : <b>" + this.point.name + "</b><br/>" + translate("Profit") + " : <b>" + Highcharts.numberFormat(this.point.y, 2) + "</b><br/>" + translate("Percentage") + " : <b>" + Highcharts.numberFormat(this.percentage, 2) + "%</b>";
                }
            },
            plotOptions:
            {
